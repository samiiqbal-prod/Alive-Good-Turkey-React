        ...
        <div className="footer4-content">
          ...
          <div className="footer4-links">
            ...
            >
              {props.link2 ?? (
                <Fragment>
                  <span className="footer4-text14">Rooms</span>
                </Fragment>
              )}
            </a>
            <a
            ...
            >
              {props.link4 ?? (
                <Fragment>
                  <span className="footer4-text18">Loyalty Program</span>
                </Fragment>
              )}
            </a>
            <a
            ...
            >
              {props.link5 ?? (
                <Fragment>
                  <span className="footer4-text15">Contact Us</span>
                </Fragment>
              )}
            </a>
          </div>
...
Footer4.defaultProps = {
  link2: undefined,
  link5: undefined,
  logoAlt: 'Green Tourism Hotels Logo',
  link1: undefined,
  link3: undefined,
  link4: undefined,
  termsLink: undefined,
