                ...
                {props.feature1Description ?? (
                  <Fragment>
                    <span className="features24-text3">
                      Indulge in our well-appointed rooms designed to provide a
                      relaxing stay with all the necessary amenities.
                    </span>
                  </Fragment>
                )}
              </span>
          ...
          >
            ...
            <div className="features24-content2">
              <h2 className="thq-heading-2">
                {props.feature2Title ?? (
                  <Fragment>
                    <span className="features24-text4">Guided Tours</span>
                  </Fragment>
                )}
              </h2>
              <span className="thq-body-small">
                {props.feature2Description ?? (
                  <Fragment>
                    <span className="features24-text6">
                      Experience guided tours to explore the beautiful
          ...
          >
            ...
            <div className="features24-content3">
              <h2 className="thq-heading-2">
                {props.feature3Title ?? (
                  <Fragment>
                    <span className="features24-text1">Restaurant</span>
                  </Fragment>
                )}
              </h2>
              <span className="thq-body-small">
                {props.feature3Description ?? (
                  <Fragment>
                    <span className="features24-text5">
                      Enjoy delicious meals at our on-site restaurant, offering
                      a variety of cuisines to satisfy your taste buds.
                    </span>
                  </Fragment>
                )}
              </span>
...
Features24.defaultProps = {
  feature1ImgAlt: 'Luxurious Room with a View',
  ...
  feature3ImgAlt: 'Restaurant Interior',
  ...
  feature2ImgAlt: 'Guided Tour Group',
