          ...
          <div className="steps2-container3">
                ...
                {props.step1Description ?? (
                  <Fragment>
                    <span className="steps2-text29">
                      ...
                      landscapes of Pakistan, offering a unique and sustainable
                      stay experience.
                    </span>
                  </Fragment>
                )}
            ...
            <div className="steps2-container5 thq-card">
              <h2 className="thq-heading-2">
                {props.step2Title ?? (
                  <Fragment>
                    <span className="steps2-text30">Book Your Room</span>
                  </Fragment>
                )}
              </h2>
                ...
                {props.step2Description ?? (
                  <Fragment>
                    <span className="steps2-text32">
                      Choose from a variety of comfortable and environmentally
                      conscious rooms that cater to your needs and preferences.
                    </span>
                  </Fragment>
                )}
              </span>
            ...
            <div className="steps2-container6 thq-card">
              <h2 className="thq-heading-2">
                {props.step3Title ?? (
                  <Fragment>
                    <span className="steps2-text27">Enjoy Our Services</span>
                  </Fragment>
                )}
              </h2>
